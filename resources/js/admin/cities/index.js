    ...
    methods: {
        ...
        setConfig() {
            ...
            vm.config = {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                var permissions = [
                                    {
                                        name: 'cities-view',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.cities.show', data)+"' class='dropdown-item'><i class='fa fa-eye p-2 m-1 fa-lg align-middle'></i> " + vm.$t('staff/buttons.view') + "</a>"; }
                                    },
                                    {
                                        name: 'cities-edit',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.cities.edit', data)+"' class='dropdown-item'><i class='fa fa-edit p-2 m-1 fa-lg'></i> " + vm.$t('staff/buttons.edit') + "</a>"; }
                                    },
                                    {
                                        name: 'cities-delete',
                ...
                url: {
                    list: vm.$route('admin.ajax.cities.list'),
                    delete: 'admin.cities.destroy'
                },
                notifications: {
                    delete: vm.$t('staff/notifications.cities_deleted_successfully')
                }
            };
        }
    }
