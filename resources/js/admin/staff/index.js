    ...
    methods: {
        ...
        setConfig() {
            ...
            vm.config = {
                options: {
                    ...
                    columnDefs: [
                            ...
                            render: function(data, type, row) {
                                ...
                                if (vm.$helper.isNotNull(data)) {
                                    element = '<span class="kt-badge kt-badge--' + badge[data].type + ' kt-badge--inline">' + 
                                        vm.$t('staff/tables.staff_status_'+data) + '</span>';
                                }
                                return element;
                            }
                        },
                        {
                            targets: [3],
                            render: function(data, type, row) {
                                return '<span class="kt-badge kt-badge--inline kt-badge--primary">' + vm.$helper.capitalize(vm.$helper.getValue(data)) + '</span>';
                            }
                        },
                        {
                            targets: [4],
                            ...
                            render: function(data, type, row) {
                                ...
                                var permissions = [
                                    {
                                        name: 'staff-view',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.staff.show', data)+"' class='dropdown-item'><i class='fa fa-eye p-2 m-1 fa-lg align-middle'></i> " + vm.$t('staff/buttons.view') + "</a>"; }
                                    },
                                    {
                                        name: 'staff-edit',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.staff.edit', data)+"' class='dropdown-item'><i class='fa fa-edit p-2 m-1 fa-lg'></i> " + vm.$t('staff/buttons.edit') + "</a>"; }
                                    },
                                    {
                                        name: 'staff-delete',
                ...
                url: {
                    list: vm.$route('admin.ajax.staff.list'),
                    delete: 'admin.staff.destroy'
                },
                notifications: {
                    delete: vm.$t('staff/notifications.staff_deleted_successfully')
                }
            };
        }
    }
