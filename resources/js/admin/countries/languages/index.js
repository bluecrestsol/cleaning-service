    ...
    methods: {
        ...
        setConfig() {
            ...
            vm.config = {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                return vm.$helper.getValue(data) + ' - ' + vm.$helper.getValue(row.name);
                            }
                        },
                        {
                            targets: [2],
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                var permissions = [
                                    {
                                        name: 'countries-languages-edit',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.countries.languages.edit', [ vm.main.pageData.country.id, data ])+"' class='dropdown-item'><i class='fa fa-edit p-2 m-1 fa-lg'></i> " + vm.$t('staff/buttons.edit') + "</a>"; }
                                    },
                                    {
                                        name: 'countries-languages-delete',
                ...
                url: {
                    list: vm.$route('admin.ajax.countries.languages.list', vm.main.pageData.country.id),
                    delete: 'admin.countries.languages.destroy'
                },
                notifications: {
                    delete: vm.$t('staff/notifications.countries_languages_deleted_successfully')
                }
            };
        }
    }
