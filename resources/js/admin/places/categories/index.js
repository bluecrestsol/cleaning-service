    ...
    methods: {
        ...
        setConfig() {
            ...
            vm.config = {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function ( data, type, row ) {
                                return vm.$helper.isNotNull(data) ? vm.$t('staff/tables.places_categories_type_'+data) : '';
                            }
                        },
                        {
                            targets: [3],
                            ...
                            render: function(data, type, row) {
                                ...
                                var permissions = [
                                    {
                                        name: 'places-categories-view',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.places.categories.show', data)+"' class='dropdown-item'><i class='fa fa-eye p-2 m-1 fa-lg align-middle'></i> " + vm.$t('staff/buttons.view') + "</a>"; }
                                    },
                                    {
                                        name: 'places-categories-edit',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.places.categories.edit', data)+"' class='dropdown-item'><i class='fa fa-edit p-2 m-1 fa-lg'></i> " + vm.$t('staff/buttons.edit') + "</a>"; }
                                    },
                                    {
                                        name: 'places-categories-delete',
                ...
                url: {
                    list: vm.$route('admin.ajax.places.categories.list'),
                    delete: 'admin.places.categories.destroy'
                },
                notifications: {
                    delete: vm.$t('staff/notifications.places_categories_deleted_successfully')
                }
            };
        }
    }
