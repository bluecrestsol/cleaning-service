    ...
    methods: {
        ...
        setConfig() {
            ...
            vm.config = {
                                ...
                                var permissions = [
                                    {
                                        ...
                                        callback: () => { actions += "<a href='"+vm.$route('admin.currencies.show', data)+"' class='dropdown-item'><i class='fa fa-eye p-2 m-1 fa-lg align-middle'></i> " + vm.$t('staff/buttons.view') + "</a>"; }
                                    },
                                    {
                                        name: 'currencies-edit',
                                        callback: () => { actions += "<a href='"+vm.$route('admin.currencies.edit', data)+"' class='dropdown-item'><i class='fa fa-edit p-2 m-1 fa-lg'></i> " + vm.$t('staff/buttons.edit') + "</a>"; }
                                    },
                                    {
                ...
                url: {
                    list: vm.$route('admin.ajax.currencies.list'),
                    delete: 'admin.currencies.destroy'
                },
                notifications: {
                    delete: vm.$t('staff/notifications.currencies_deleted_successfully')
                }
            };
        }
    }
