...
/**
 * Crew member store form request
 */
class CrewMemberStoreRequest extends FormRequest
{
     /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'company_id' => 'nullable',
            'country_id' => 'nullable',
            'email' => 'nullable|email|unique:crew_members',
        ...
        if ($method == 'PUT') {
            $rules['email'] .= ",email,{$this->route('crew_member')}";
        }
