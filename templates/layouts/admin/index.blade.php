...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ url('assets/admin/vendors/global/vendors.bundle.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
        ...
        <div id="app"
            data-vue-page="{{ $page ?? null }}"
            data-vue-props="{{ json_encode($data ?? null) }}"
            v-cloak>
            <!-- begin:: Page -->
            <!-- begin:: Header Mobile -->
            <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
                <div class="kt-header-mobile__logo">
                    <a href="{!! route('admin.dashboard') !!}">
                        <img alt="Logo" src="{{ url('assets/admin/media/logos/logo_admin.png') }}" />
                    </a>
                </div>
                    ...
                    <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                        ...
                        <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                            <div class="kt-aside__brand-logo">
                                <a href="{!! route('admin.dashboard') !!}">
                                    <img alt="Logo" src="{{ url('assets/admin/media/logos/logo_admin.png') }}" width="100%" />
                                </a>
                            </div>
                        ...
                        <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                            <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                                <ul class="kt-menu__nav">
                                    {{-- dashboard --}}
                                    <li class="kt-menu__item {{ (request()->segment(2) == 'dashboard') ? 'kt-menu__item--active' : '' }}">
                                        <a href="{!! route('admin.login') !!}" class="kt-menu__link">
                                            ...
                                            <span class="kt-menu__link-text">{{ __('staff/navigations.dashboard') }}</span>
                                        </a>
                                    </li>
                                    @each('layouts.admin.navigation', [
                                        [
                                            'section' => true,
                                            'name' => 'Operations',
                                        ],
                                        [
                                            'name' => 'crew_members',
                                            'link' => route('admin.crew_members.index'),
                                            'icon' => 'fas fa-user-shield',
                                            'active' => request()->segment(2) === 'crew-members',
                                            'visible' => $admin->hasPermissionTo('crew-members'),
                                        ],
                                        [
                                            'name' => 'agents',
                                            'link' => route('admin.agents.index'),
                                            'icon' => 'fas fa-user-ninja',
                                            'active' => request()->segment(2) === 'agents',
                                            'visible' => $admin->hasPermissionTo('agents'),
                                        ],
                                        [
                                            'name' => 'customers',
                                            'link' => route('admin.customers.index'),
                                            'icon' => 'fas fa-user',
                                            'active' => request()->segment(2) === 'customers',
                                            'visible' => $admin->hasPermissionTo('customers'),
                                        ],
                                        [
                                            'name' => 'places',
                                            'link' => route('admin.places.index'),
                                            'icon' => 'fas fa-map-marker',
                                            'active' => request()->segment(2) === 'places' && request()->segment(3) !== 'categories',
                                            'visible' => $admin->hasPermissionTo('places'),
                                        ],
                                        [
                                            'name' => 'contracts',
                                            'link' => route('admin.contracts.index'),
                                            'icon' => 'fas fa-file-contract',
                                            'active' => request()->segment(2) === 'contracts',
                                            'visible' => $admin->hasPermissionTo('contracts'),
                                        ],
                                        [
                                            'name' => 'appointments',
                                            'link' => route('admin.appointments.index'),
                                            'icon' => 'fas fa-calendar-check',
                                            'active' => request()->segment(2) === 'appointments',
                                            'visible' => $admin->hasPermissionTo('appointments'),
                                        ],
                                        [
                                            'name' => 'bookings',
                                            'link' => route('admin.bookings.index'),
                                            'icon' => 'fas fa-clipboard-list',
                                            'active' => request()->segment(2) === 'bookings',
                                            'visible' => $admin->hasPermissionTo('bookings'),
                                        ],
                                        [
                                            'name' => 'contact_requests',
                                            'link' => route('admin.contact_requests.index'),
                                            'icon' => 'fas fa-envelope',
                                            'active' => request()->segment(2) === 'contact-requests',
                                            'visible' => $admin->hasPermissionTo('contact-requests'),
                                        ],
                                        [
                                            'section' => true,
                                            'name' => 'Admins',
                                        ...
                                        [
                                            ...
                                            'active' => request()->segment(2) === 'staff',
                                            'visible' => $admin->hasPermissionTo('staff'),
                                        ],
                                        [
                                            'name' => 'roles',
                                            ...
                                            'visible' => $admin->hasPermissionTo('roles'),
                                        ],
                                        [
                                            'section' => true,
                                            'name' => 'Configuration',
                                        ...
                                        [
                                            ...
                                            'children' => [
                                                [
                                                    ...
                                                    'active' => request()->segment(2) === 'countries',
                                                    'visible' => $admin->hasPermissionTo('countries'),
                                                ],
                                                [
                                                    'name' => 'states',
                                                    'link' => route('admin.states.index'),
                                                    'active' => request()->segment(2) === 'states',
                                                    'visible' => $admin->hasPermissionTo('states'),
                                                ],
                                                [
                                                    'name' => 'cities',
                                                    'link' => route('admin.cities.index'),
                                                    'active' => request()->segment(2) === 'cities',
                                                    'visible' => $admin->hasPermissionTo('cities'),
                                                ],
                                                [
                                                    'name' => 'districts',
                                                    'link' => route('admin.districts.index'),
                                                    'active' => request()->segment(2) === 'districts',
                                                    'visible' => $admin->hasPermissionTo('districts'),
                                                ],
                                                [
                                                    'name' => 'languages',
                                                    'link' => route('admin.languages.index'),
                                                    'active' => request()->segment(2) === 'languages',
                                                    'visible' => $admin->hasPermissionTo('languages'),
                                                ],
                                                [
                                                    'name' => 'currencies',
                                                    'link' => route('admin.currencies.index'),
                                                    'active' => request()->segment(2) === 'currencies',
                                                    'visible' => $admin->hasPermissionTo('currencies'),
                                                ]
                                            ]
                                        ],
                                        [
                                            ...
                                            'visible' => $admin->hasPermissionTo('companies'),
                                        ],
                                        [
                                            'name' => 'services',
                                            'link' => route('admin.services.index'),
                                            'icon' => 'fas fa-spray-can',
                                            'active' => request()->segment(2) === 'services',
                                            'visible' => $admin->hasPermissionTo('services'),
                                        ],
                                        [
                                            'name' => 'places_categories',
                                            'link' => route('admin.places.categories.index'),
                                            'icon' => 'fas fa-map-marker',
                                            'active' => request()->segment(2) === 'places' && request()->segment(3) === 'categories',
                                            'visible' => $admin->hasPermissionTo('places-categories'),
                                        ],
                                        [
                                            'name' => 'faqs',
                                            ...
                                            'children' => [
                                                [
                                                    ...
                                                    'link' => route('admin.faqs_categories.index'),
                                                    'active' => request()->segment(2) === 'faqs-categories',
                                                    'visible' => $admin->hasPermissionTo('faqs-categories'),
                                                ],
                                                [
                                                    'name' => 'faqs_questions',
                                                    'link' => route('admin.faqs_questions.index'),
                                                    'active' => request()->segment(2) === 'faqs-questions',
                                                    'visible' => $admin->hasPermissionTo('faqs-questions'),
                                                ]
                                            ]
                                        ],
                                    ], 'menu', null)
                ...
                -->
                                    ...
                                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                                        <form>
                                            ...
                                            <!--begin: Head -->
                                            <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(./assets/admin/media/misc/bg-1.jpg)">
                                ...
                                <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                                    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                        <span class="kt-header__topbar-icon">
                                            <img class=""
                                                src="{{ url('assets/admin/media/flags/'.app()->getLocale().'.svg') }}"
                                                alt=""/>
                                        </span>
                                    </div>
                                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                                        <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                            @foreach ($main['languages'] as $language)
                                            <li class="kt-nav__item {{ (app()->getLocale() == strtolower($language->code)) ? 'active' : '' }}">
                                                <a href="{!! route('admin.main.language.change', [strtolower($language->code)]) !!}" class="kt-nav__link">
                                                    <span class="kt-nav__link-icon"><img
                                                                src="{{ url('assets/admin/media/flags/'.$language->code.'.svg') }}"
                                                                alt=""/></span>
                                                    <span class="kt-nav__link-text">{{ $language->english_name }}</span>
                                                </a>
                                            </li>
                                            @endforeach
                                        </ul>
                                ...
                                <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                                        <div class="kt-header__topbar-user">
                                            ...
                                            <span class="kt-header__topbar-username kt-hidden-mobile">{{ Session::get('first_name') }} {{ Session::get('last_name') }} </span>
                                            <img class="kt-hidden" alt="Pic" src="{{ url('assets/admin/media/users/300_25.jpg') }}" />

                                            <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                            <span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{ Session::get('user_initial') }}</span>
                                        </div>
                                    </div>
                                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                                        ...
                                        <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(./assets/admin/media/misc/bg-1.jpg)">
                                            <div class="kt-user-card__avatar">
                                                ...
                                                <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                                <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{ Session::get('user_initial') }}</span>
                                            </div>
                                        ...
                                        <div class="kt-notification">
                                            <!-- <a href="route('changelocale', ['en'])" class="kt-notification__item">
                                                <div class="kt-notification__item-icon">
                                ...
                                <div class="kt-subheader__main">
                                    <collection
                                        variables='<?php echo json_encode([
                                            'shared' => [
                                                'others' => app('shared')->get('others')
                                            ]
                                        ]); ?>'>
                                    </collection>
                                    {!! Form::open(['route' => ['admin.admin_user.active.update'], 
                                        'method' => 'POST']) !!}
                                        @foreach ([
                                            [
                                                'id' => 'active-company',
                                                ...
                                                'name' => 'company',
                                                'placeholder' => __('staff/titles.heading_select_company')
                                            ],
                                            [
                                                'id' => 'active-country',
                                                'list' => $main['countries'],
                                                'column' => 'active_country_id',
                                                'name' => 'country',
                                                'placeholder' => __('staff/titles.heading_select_country')
                                            ]
                                        ] as $group)
                                            <select2
                                                id="{{ $group['id'] }}"
                                                wrapper-id="wrapper-{{ $group['id'] }}"
                                                name="{{ $group['column'] }}"
                                                initial="{{ (isset($admin)) ? $admin->{$group['column']} : '' }}"
                                                v-model="main.{{ $group['name'] }}.value"
                                                :options.sync="main.{{ $group['name'] }}.options"
                                                :initial-options="{{ toSelect2Format($group['list'], ['id', 'name']) }}"
                                                placeholder="{{ $group['placeholder'] }}"
                                                @select="onSelectTitleChanged"
                                            ></select2>
                                        @endforeach
                                    {!! Form::close() !!}
                                </div>
    ...
    {{--                            @endif--}}
                                ...
                                @yield('content')
                                {{-- @include('admin._partials.toaster') --}}
                        ...
                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                            <div class="kt-footer__copyright">
                                2020&nbsp;&copy;&nbsp;<a href="{{ url('/') }}" target="_blank" class="kt-link">{{ config('app.name') }}</a>
                            </div>
                        </div>
        ...
        <script>
            ...
            window.permissions = <?php echo json_encode($adminPermissions); ?>;
        ...
        <script src="{{ url('assets/admin/vendors/global/vendors.bundle.js') }}" type="text/javascript"></script>
        <script src="{{ url('assets/admin/vendors/general/moment/min/moment-timezone-with-data.min.js') }}" type="text/javascript"></script>
        <script src="{{ url('assets/admin/js/demo1/scripts.bundle.js') }}" type="text/javascript"></script>

        <!--end::Global Theme Bundle -->

        <!--begin::Page Vendors(used by this page) -->
        <script src="{{ url('assets/admin/vendors/custom/fullcalendar/fullcalendar.bundle.js') }}" type="text/javascript"></script>
        <script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script>
        <script src="{{ url('assets/admin/vendors/custom/gmaps/gmaps.js') }}" type="text/javascript"></script>

        <!--end::Page Vendors -->

        <!--begin::Page Scripts(used by this page) -->
        <script src="{{ url('assets/admin/js/demo1/pages/dashboard.js') }}" type="text/javascript"></script>
