<div class="kt-section">
    ...
    <div class="kt-section__body">
        <div class="form-group">
            ...
            <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : ''}}" name="email" value="{{ old('email', $agent->email ?? '') }}">
        ...
        <div class="form-group">                                    
            ...
            <mobile :config="mobile.config"
                initial="{{ old('mobile_number', $agent->mobile_number ?? '') }}"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('line') ? 'is-invalid' : ''}}" name="line" value="{{ old('line', $agent->line ?? '') }}">
        ...
        <div class="form-group form-group-last">                                    
            ...
            <mobile :config="whatsapp.config"
                initial="{{ old('whatsapp', $agent->whatsapp ?? '') }}"
